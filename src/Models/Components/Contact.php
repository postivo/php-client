...
/** Contact - Contact data for an Address Book entry. */
class Contact
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(?string $name = null, ?string $address = null, ?string $postCode = null, ?string $city = null, ?string $name2 = null, ?string $homeNumber = null, ?string $flatNumber = null, ?string $phoneNumber = null, ?string $extId = null, ?array $groupIds = null, ?string $country = 'PL')
    {
        $this->name = $name;
