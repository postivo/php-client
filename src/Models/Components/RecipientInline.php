...
class RecipientInline
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $name = null, ?string $address = null, ?string $postCode = null, ?string $city = null, ?string $name2 = null, ?string $homeNumber = null, ?string $flatNumber = null, ?string $phoneNumber = null, ?string $postscript = null, ?string $country = 'PL', ?string $customId = null)
    {
        $this->name = $name;
